...
#if !defined(CONFIG_SOC_MT8365) && !defined(CONFIG_SOC_SERIES_MT8370)
struct mtk_ostimer {
	unsigned int con;
	unsigned int rst;
	unsigned int cur;
...
#elif defined(CONFIG_SOC_SERIES_MT8370)
/* mt8370 specific clock source definitions - not implemented */
#else
